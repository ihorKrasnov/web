...
class ColorPoint {
    ...
    public function clone(): ColorPoint {
        $clone = new self();
        $clone->set($this->x, $this->y, $this->color);
        return $clone;
    }
...
// Приклад використання класу масиву, що складається з об'єктів класу
$listOfPoints = [];
...
// Створення нового об'єкта на основі прототипу
$clonedPoint = $listOfPoints[0]->clone();
$clonedPoint->set(30, 40, 'Yellow');
...
// Додавання клонованого об'єкта в масив
$listOfPoints[] = $clonedPoint;

// Показуємо всі об'єкти, включаючи клонований
ColorPoint::show_objects($listOfPoints);
